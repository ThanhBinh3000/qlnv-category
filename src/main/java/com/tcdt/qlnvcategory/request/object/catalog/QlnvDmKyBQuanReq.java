...
@Data
public class QlnvDmKyBQuanReq {
	@ApiModelProperty(notes = "Bắt buộc set đối với update")
	Long id;
	
	@NotNull(message = "Không được để trống")
	@Size(max = 20, message = "Mã kỳ không được vượt quá 20 ký tự")
	@ApiModelProperty(example = "KL_1")
	String maKy;
	
	@NotNull(message = "Không được để trống")
	@Size(max = 250, message = "Tên kỳ không được vượt quá 250 ký tự")
	@ApiModelProperty(example = "Tên kỳ 1")
	String tenKy;
