...
@Data
public class QlnvDmPthucBquanReq {
	@ApiModelProperty(notes = "Bắt buộc set đối với update")
	Long id;

	@NotNull(message = "Không được để trống")
	@Size(max = 20, message = "Mã phương thức bảo quản không được vượt quá 20 ký tự")
	@ApiModelProperty(example = "PT_1")
	String maPthuc;

	@NotNull(message = "Không được để trống")
	@Size(max = 250, message = "Tên phương thức bảo quản không được vượt quá 250 ký tự")
