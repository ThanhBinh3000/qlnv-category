...
public interface QlnvDmDmucCcuRepository extends CrudRepository<QlnvDmDmucCcu, Long> {
	@Query(value = "SELECT t.ID,t.CAP_DVI,(select ten_ccu from dm_congcu where ma_ccu = t.NHOM_CCU) NHOM_CCU,(select ten_lhinh from _dm_nhapxuat where ma_lhinh = t.LOAI_NHAPXUAT) LOAI_NHAPXUAT,"
